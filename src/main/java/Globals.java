public class Globals {
    ...
    //                                       600, 550, 500, 450, 400, 350, 300    Sponsorship video
    public static int[] sponsors_pay_amount ={40,  42,  41,  45,  50,  70, 150};    //   250
    public static int[] sponsors_pay_days = { 15,  13,  12,   10,   8,   5,   2};    //     1
